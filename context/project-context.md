...
**See [project-structure.md](project-structure.md) for detailed decision trees and examples.**
...
**See [project-structure.md](project-structure.md) for detailed organization strategy and file naming conventions.**
...
**For comprehensive documentation of the TARGET directory structure and file organization, see [project-structure.md](project-structure.md).**
...
This section provides fast answers to common questions. For detailed explanations, see [project-structure.md](project-structure.md).
...
**For comprehensive coding patterns, detailed examples, and best practices, see [code-conventions.md](code-conventions.md).**
...
**See [code-conventions.md](code-conventions.md) for:**
